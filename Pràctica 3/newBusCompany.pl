...
satVariable(  tooMany(C1-C2) ) :- trip(C1-C2).  % trip C1-C2 is done too many times
satVariable(  tooFew(C1-C2) ) :- trip(C1-C2).  % trip C1-C2 is done too few times
satVariable(  tooLong(C1-C2-C3) ) :- tooLongDist(C1-C2-C3).  % trip C1-C2-C3 is too long
...
atLeastOneTripPerDay :- day(D), findall(bdcc(B,D,C1,C2), bus(B), Lits), atLeast(1,Lits), fail.
atLeastOneTripPerDay.

atLeastMinFreq :- trip(C1-C2), frequency(C1-C2,F), findall(bdcc(B,D,C1,C2), (bus(B),day(D)), Lits), atLeast(F,Lits), fail.
atLeastMinFreq.

atMostMaxFreq :- trip(C1-C2), frequency(C1-C2,F), findall(bdcc(B,D,C1,C2), (bus(B),day(D)), Lits), atMost(F,Lits), fail.
atMostMaxFreq.

atMostMaxDist :- tooLongDist(C1-C2-C3), findall(bdcc(B,D,C1,C2), (bus(B),day(D)), Lits1), findall(bdcc(B,D,C2,C3), (bus(B),day(D)), Lits2), 
    expressOr(tooLong(C1-C2-C3), Lits1), expressOr(tooLong(C1-C2-C3), Lits2), fail.
atMostMaxDist.
